...
class Functions_Practice < MiniTest::Test
  ...
  def test_largest_personal_account_holder
      largest_personal_account_holder = largest_personal_account_holder()
  ...
  def test_total_cash_in_business_accounts
      total_cash_in_business_accounts = total_cash_in_business_accounts()
      assert_equal(7055, total_cash_in_business_accounts)
  end
