...
/***/ function(module, exports, __webpack_require__) {
	...
	var sampleData = [{ id: 1, author: 'Keith', text: 'Boom!' }, { id: 2, author: 'Rick', text: 'Cool' }, { id: 3, author: 'Val', text: 'Pikachu' }, { id: 4, author: 'Seumus', text: 'SHOTS!' }];
	...
	var CommentBox = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            'CommentBox',
	            React.createElement(CommentList, { ondelete: this.handleCommentDelete, data: this.state.data, __self: this
	            }),
	...
	var CommentList = React.createClass({
	    ...
	    render: function render() {
	        var commentArray = this.props.data.map(function (item) {
	            return React.createElement(Comment, { key: item.id, id: item.id, ondelete: this.props.ondelete, author: item.author, text: item.text, __self: this
	            });
	        }.bind(this));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CommentForm = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            'form',
	            { onSubmit: this.handleFormSubmit, __self: this
	            },
	            React.createElement('input', { type: 'text', ref: 'author_input', placeholder: 'Your name....', value: this.state.author, onChange: this.handleAuthorChange, __self: this
	            }),
	            React.createElement('input', { type: 'text', ref: 'text_input', placeholder: 'Your comment....', value: this.state.text, onChange: this.handleTextChange, __self: this
	            }),
	            React.createElement('input', { type: 'submit', value: 'Add Comment', __self: this
	            })
	        );
	    },
