...
/***/ function(module, exports, __webpack_require__) {
	...
	window.onload = function () {
	  ...
	  ReactDOM.render(React.createElement(Counter, { title: 'Jack the Counter', __self: this
	...
	var Counter = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement('input', { type: 'number', onKeyUp: this.setMultiplier, __self: this
	            })
	        );
	    },
	    ...
	    setMultiplier: function setMultiplier(event) {
