	...
	var CommentBox = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(CommentList, { data: this.state.data, deleteComment: this.deleteComment }),
	    ...
	    grabComments: function grabComments() {
	        var req = new XMLHttpRequest();
	...
	var CommentList = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var commentNodes = this.props.data.map(function (comment) {
	      return React.createElement(Comment, { deleteComment: this.props.deleteComment, comment: comment, key: comment._id });
	    }.bind(this));
